...
def create_app(config_name):
    app = Flask(__name__) # most of the work is done right here
    app.config.from_object('settings') # load my settings/ private.py stuff
    
    # images
    #load m image uploader extension
    ...
    # custom error handlers, these call the functions at the top of the title
