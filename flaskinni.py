import os # gives me tools to get my own IP and manage my computer.
from dotenv import load_dotenv # connect me to any .env files
...
migrate = Migrate(app, db) # activate my database ungrader tool
